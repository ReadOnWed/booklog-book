...
@Repository
public class MostReviewedInMonthBookInfoRepository implements BookInfoRepository{
	@Override
	public List<BookInfoDto> findBookInfos() {
		...
		bookInfoList.add(
			BookInfoDto.builder()
				.id("1")
				.title("Recent Reviewed In Month Top 1")
				.rating(45)
		...
		bookInfoList.add(
			BookInfoDto.builder()
				.id("2")
				.title("Recent Reviewed In Month Top 2")
				.rating(45)
				.totalReviewsCount(30)
				.recentReviewDate("2022-01-01")
				.author("Author Y")
		...
		bookInfoList.add(
			BookInfoDto.builder()
				.id("3")
				.title("Recent Reviewed In Month Top 3")
				.rating(45)
				.totalReviewsCount(30)
				.recentReviewDate("2022-01-01")
				.author("Author Z")
